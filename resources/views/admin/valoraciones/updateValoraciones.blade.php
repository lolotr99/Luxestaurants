...
@section('content')
    <div class="container text-secondary">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <label for="filtroValoracionEditar">Ordenar por: </label>
                                <select id="filtroValoracionEditar" name="filtroValoracionEditar" class="form-control">
                        ...
                        <div class="col-6">
                            <div class="row ml-2">
                                <label for="buscadorValoracionesEditar">Busca por email o nombre de usuario </label>
                                <input type="text" class="form-control" name="buscadorValoracionesEditar" id="buscadorValoracionesEditar" placeholder="busca por email o nombre de usuario">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row" id="valoracionesEditar">
