            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="row ml-2">
                                <label for="buscadorPlatosEliminar">Busca por nombre de plato </label>
                                <input type="text" class="form-control" name="buscadorPlatosEliminar" id="buscadorPlatosEliminar" placeholder="busca por nombre de plato">
                            </div>
                        </div>
                    </div>
                </div>
