            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <label for="filtroValoracion">Ordenar por: </label>
                                <select id="filtroValoracion" name="filtroValoracion" class="form-control">
                        ...
                        <div class="col-6">
                            <div class="row ml-2">
                                <label for="buscadorValoraciones">Busca por email o nombre de usuario </label>
                                <input type="text" class="form-control" name="buscadorValoraciones" id="buscadorValoraciones" placeholder="busca por email o nombre de usuario">
                            </div>
                        </div>
                    </div>
                </div>
