...
class DatabaseSeeder extends Seeder
{
    ...
    public function seedCarta() {
        Plato::create(array('nombrePlato' => 'Omelette de Caviar Sevruga', 'descripcion' => 'La tortilla más cara del mundo no alcanza ese precio por su elaboración, sino por sus ingredientes. Consta de 6 huevos, caviar sevruga y una langosta acompañados de hierbas finas. Se sirve como desayuno y su presentación lo hace accesible solo para unos pocos.','imagenPlato' => 'img/carta/omeletteCaviarSevruga.png','precioPlato'=> 637,'categoria' => 'plato'));
        Plato::create(array('nombrePlato' => 'Jamón ibérico Cinco Jotas', 'descripcion' => '80 g del mejor jamón de Cinco Jotas. Es 100% ibérico de bellota y tiene su origen en animales que han sido criados en libertad y han permanecido en la dehesa durante 4 años con controles de calidad muy estrictos.','imagenPlato' => 'img/carta/jamonIberico5jotas.png','precioPlato'=> 29,'categoria' =>'entrante'));
        Plato::create(array('nombrePlato' => 'Queso de leche de alce', 'descripcion' => '80 g de queso de alce. Este queso se elabora a partir de la leche de los alces de la granja Moose House, al norte de Suecia. La exclusividad de este viene dada porque las hembras solo se pueden ordeñar entre mayo y septiembre.','imagenPlato' => 'img/carta/quesoLecheAlce.png','precioPlato'=> 86,'categoria' =>'entrante'));
        Plato::create(array('nombrePlato' => 'Matsukake', 'descripcion' => 'El matsukake japonés tiene una variedad exclusiva porque crece debajo del pino rojo de la isla. Su producción anual es muy limitada de ahí su alto coste.','imagenPlato' => 'img/carta/matsukake.png','precioPlato'=> 25,'categoria' =>'plato'));
        Plato::create(array('nombrePlato' => 'Sukiyaki de Wagyu', 'descripcion' => 'Se trata de un solomillo en trozos, proveniente del buey de Wagyu, una raza que habita en Kobe (Japón). Es un filete único en su tipo, por su alto grado de marmoleo, suavidad y gran sabor además de la nula presencia de grasa.','imagenPlato' => 'img/carta/sukiyakiWagyu.png','precioPlato'=> 45,'categoria' =>'plato'));
        Plato::create(array('nombrePlato' => 'Tarta de mouse de trufa blanca', 'descripcion' => 'Tarta de mouse de chocolate blanco ambientada con un poco de trufa blanca. El precio de esta se eleva debido al coste de adquisición de la trufa blanca.','imagenPlato' => 'img/carta/tartaTrufaBlanca.png','precioPlato'=> 27,'categoria' =>'postre'));
        Plato::create(array('nombrePlato' => 'Sashimi de fugu', 'descripcion' => 'Proviene de la cocina de lujo japonesa y debe su nombre a las distintas preparaciones gastronómicas del pez globo de la isla. Requiere ser preparado por cocineros expertos debido al riesgo de la tetradotoxina, veneno mortal para los humanos.','imagenPlato' => 'img/carta/fugu.png','precioPlato'=> 260,'categoria' =>'plato'));
        Plato::create(array('nombrePlato' => 'Rollitos de lenguado', 'descripcion' => 'Este plato de pescado es típico en comidad navideñas o festivas. Son unos rollitos hechos con filetes de lenguado, rellenos de gambas y trigueros, al vino de chacolí','imagenPlato' => 'img/carta/rollitosLenguado.png','precioPlato'=> 25,'categoria' =>'plato'));
        Plato::create(array('nombrePlato' => 'Mero con berenjenas', 'descripcion' => 'El mero es un pescado blanco muy aprecidado, que con el adobo gana mucho en sabor. Este con berenjenas y tomatitos cherry te hará disfrutar de una experiencia única.','imagenPlato' => 'img/carta/meroBerenjenas.png','precioPlato'=> 22,'categoria' =>'plato'));
        Plato::create(array('nombrePlato' => 'Silla de cordero', 'descripcion' => 'La textura de este plato te conquistará el paladar. Su tierna y jugosa carne será la protagonista de una lujosa y deliciosa comida.','imagenPlato' => 'img/carta/sillaCordero.png','precioPlato'=> 30,'categoria' =>'plato'));
        Plato::create(array('nombrePlato' => 'Coca de sardinas', 'descripcion' => 'El crujiente sabor de esta coca de sardinas se basa en nuestro secreto en el modo de hornearlas. Disfruta de una experiencia única con nuestra coca de sardinas','imagenPlato' => 'img/carta/cocaSardinas.png','precioPlato'=> 15,'categoria' =>'plato'));
