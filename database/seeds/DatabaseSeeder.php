...
class DatabaseSeeder extends Seeder
{
    ...
    public function seedCarta() {
        ...
        Plato::create(array('nombrePlato' => 'Tarta de mouse de trufa blanca', 'descripcion' => 'Tarta de mouse de chocolate blanco ambientada con un poco de trufa blanca. El precio de esta se eleva debido al coste de adquisición de la trufa blanca.','imagenPlato' => 'img/carta/tartaTrufaBlanca.png','precioPlato'=> 0));
