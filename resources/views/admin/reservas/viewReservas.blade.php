            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <label for="filtroReserva">Ordenar por</label>
                        ...
                        <div class="col-6">
                            <div class="row ml-2">
                                <label for="buscadorReservas">Busca por email o nombre de usuario </label>
                                <input type="text" class="form-control" id="buscadorReservas" placeholder="busca por email o nombre de usuario">
                            </div>
                        </div>
                    </div>
                </div>
